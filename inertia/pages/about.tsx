    ...
    <Layout>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 mb-8">
          ...
          <p>Ce site est inspiré du <a href="https://cobble.ultralion.xyz/" className=" hover:text-primary-200 underline transition"> siteweb de l'instance cobble</a> créé par le développeur et joueur <a
            href="https://ultralion.xyz/" className=" hover:text-primary-200 underline transition"> UltraLion</a></p>
        </div>
